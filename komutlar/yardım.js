...
exports.run = (client, message, args) => {
  ...
  const embed = new Discord.RichEmbed()
    .setColor('RANDOM')
    .setThumbnail('https://cdn.discordapp.com/attachments/487719679868272689/488329963926192158/image0.png')
